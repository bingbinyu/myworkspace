...
\begin{center}
    \begin{tikzpicture}[>=stealth',shorten >=1pt,auto,node distance=2cm,semithick,align=left,scale=0.24, every node/.style={scale=0.24}]
        ...
        \draw[blkclr,ultra thin,fill=green]     (40,0)  rectangle                                                               (41,2);
        \draw[blkclr,ultra thin,fill=green]     (41,0)  rectangle                                                               (42,2);
        \draw[blkclr,ultra thin,fill=white]     (42,0)  rectangle                                                               (43,2);
        \draw[blkclr,ultra thin,fill=white]     (43,0)  rectangle   node[at end, above]{\color{black}{\textbf{\Huge 44}}}       (44,2);
